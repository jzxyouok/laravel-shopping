...
<script src="{{ asset('backstage/plugins/input-mask/jquery.inputmask.js') }}"></script>
<!-- <script src="{{ asset('backstage/plugins/input-mask/jquery.inputmask.numeric.extensions.js') }}"></script> -->
<!-- <script src="{{ asset('backstage/plugins/input-mask/jquery.inputmask.date.extensions.js') }}"></script> -->
...
<script type="text/javascript">
	$(function () {
        ...
        // $('input[name="price"]').inputmask('99.99', {'placeholder': '44.44',
		    // 'optionalmaker': { start: '&', end: '%'},
    // });
